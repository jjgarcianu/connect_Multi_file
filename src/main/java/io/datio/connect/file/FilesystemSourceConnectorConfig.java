...
public class FilesystemSourceConnectorConfig extends AbstractConfig {
  ...
  private static final String TABLE_POLL_INTERVAL_MS_DOC =
      "Frequency in ms to poll for new or removed files, which may result in updated task "
      + "configurations to start polling for data in added files or stop polling for data in "
      + "removed files.";
  ...
  private static final String TABLE_WHITELIST_DOC =
      "List of files to include in copying. If specified, table.blacklist may not be set.";
  ...
  private static final String TABLE_BLACKLIST_DOC =
      "List of files to exclude from copying. If specified, table.whitelist may not be set.";
  ...
  private static final String QUERY_DOC =
      ...
      + "want to join files, select subsets of columns in a table, or filter data. If used, this"
  ...
  public FilesystemSourceConnectorConfig(Map<String, String> props) {
    super(config, props);
    String mode = getString(FilesystemSourceConnectorConfig.MODE_CONFIG);
    if (mode.equals(FilesystemSourceConnectorConfig.MODE_UNSPECIFIED))
      throw new ConfigException("Query mode must be specified");
  }

  protected FilesystemSourceConnectorConfig(ConfigDef subclassConfigDef, Map<String, String> props) {
