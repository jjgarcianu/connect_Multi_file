 ...
 * example, a database Connector might create Tasks by dividing the set of files evenly among
 ...
 * previous example, the connector might periodically check for new files and notify Kafka Connect of
